...
const Sidebar = ({ setOpenMenu, openMenu }: any) => {
  ...
  return (
    <aside
      className={`flex flex-col fixed left-0 top-0 w-full min-h-screen lg:h-max z-10 bg-[var(--bgColor)] px-10 py-5 lg:w-1/5 lg:sticky lg:top-10 lg:min-h-[100vh_-_60px]`}
    >
      <BsX
