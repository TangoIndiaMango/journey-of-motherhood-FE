              ...
              <div className="relative">
                ...
                <div className="pl-10">
                  <div className="flex justify-between items-start">
                    <div className="flex item-center flex-col gap-2 md:flex-row md:gap-[20px]">
                      <h5 className="text-sm font-bold">
                        Is divorce becoming too common?
                      </h5>
                  ...
                  <p className="text-xs my-3">
                    ...
                    Facere asperiores consequuntur blanditiis quas repudiandae
                    facilis nobis dolore, eius earum, debitis aperiam mollitia,
                    alias ducimus possimus! Sint, perferendis. Placeat,
                    repellendus neque!
                  </p>
